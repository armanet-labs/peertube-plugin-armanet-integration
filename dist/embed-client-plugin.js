...
var require_videojs_ads_min = __commonJS({
  "public/scripts/videojs.ads.min.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module != "undefined" ? module.exports = t(require_video(), require_window(), require_document()) : typeof define == "function" && define.amd ? define(["video.js", "global/window", "global/document"], t) : (e = e || self).videojsContribAds = t(e.videojs, e.window, e.document);
      ...
      var o = function(e2, t2) {
        ...
        if (!(t2.type === "loadstart" && !e2.ads._hasThereBeenALoadStartDuringPlayerLife || t2.type === "loadeddata" && !e2.ads._hasThereBeenALoadedData || t2.type === "loadedmetadata" && !e2.ads._hasThereBeenALoadedMetaData))
          if (e2.ads.inAdBreak())
            r(e2, "ad", t2);
          else {
      ...
      function u(e2) {
        e2.type === "playing" ? i(this, e2) : e2.type === "ended" ? s(this, e2) : e2.type === "loadstart" || e2.type === "loadeddata" || e2.type === "loadedmetadata" ? d(this, e2) : e2.type === "play" ? l(this, e2) : this.ads.isInAdMode() && (this.ads.isContentResuming() ? r(this, "content", e2) : r(this, "ad", e2));
      }
      var c = {}, f = function() {
        !function(n2) {
          if (e.dom.isInFrame() && typeof t.__tcfapi != "function") {
            ...
            t.__tcfapi = function(e2, t2, n3, o3) {
              ...
              var t2 = {};
              try {
                t2 = typeof e2.data == "string" ? JSON.parse(e2.data) : e2.data;
              } catch (e3) {
              }
              var n3 = t2.__tcfapiReturn;
              n3 && typeof r2[n3.callId] == "function" && (r2[n3.callId](n3.returnValue, n3.success), r2[n3.callId] = null);
            }, false);
          }
        }(), typeof t.__tcfapi == "function" && t.__tcfapi("addEventListener", 2, function(e2, t2) {
          t2 && (c = e2);
        });
      }, h = function(e2, t2) {
      ...
      var g = { processMetadataTracks: function(e2, t2) {
        for (var n2 = e2.textTracks(), a2 = function(n3) {
          n3.kind === "metadata" && (e2.ads.cueTextTracks.setMetadataTrackMode(n3), t2(e2, n3));
        ...
        return t2 !== void 0 && e2.ads.includedCues[t2];
      }, v = function(e2, t2) {
        t2 !== void 0 && t2 !== "" && (e2.ads.includedCues[t2] = true);
      };
      function m() {
        this.ads._shouldBlockPlay !== false && (this.paused() || (this.ads.debug("Playback was canceled by cancelContentPlay"), this.pause()), this.ads._cancelledPlay = true);
      }
      ...
      A.isMiddlewareMediatorSupported = function() {
        ...
        return { setSource: function(e2, t3) {
          ...
          if (t2.ads && t2.ads._shouldBlockPlay === true)
          ...
          t2.ads && t2.ads._playBlocked && n2 ? (t2.ads.debug("Play call to Tech was terminated."), t2.trigger("play"), t2.addClass("vjs-has-started"), t2.ads._playBlocked = false) : a2 && a2.catch && a2.catch(function(n3) {
            n3.name !== "NotAllowedError" || e.browser.IS_SAFARI || t2.trigger("pause");
          });
        } };
      ...
      var k = function() {
        ...
        return n2.transitionTo = function(e2) {
          ...
          var t3 = this.player;
          e2 === "play" ? this.onPlay(t3) : e2 === "adsready" ? this.onAdsReady(t3) : e2 === "adserror" ? this.onAdsError(t3) : e2 === "adscanceled" ? this.onAdsCanceled(t3) : e2 === "adtimeout" ? this.onAdTimeout(t3) : e2 === "ads-ad-started" ? this.onAdStarted(t3) : e2 === "contentchanged" ? this.onContentChanged(t3) : e2 === "contentresumed" ? this.onContentResumed(t3) : e2 === "readyforpostroll" ? this.onReadyForPostroll(t3) : e2 === "playing" ? this.onPlaying(t3) : e2 === "ended" ? this.onEnded(t3) : e2 === "nopreroll" ? this.onNoPreroll(t3) : e2 === "nopostroll" ? this.onNoPostroll(t3) : e2 === "adended" && this.onAdEnded(t3);
        }, t2;
      }();
      function T(e2, t2) {
      ...
      var M = { start: function(t2) {
        ...
        t2.ads.debug("Ending ad break"), n2 === void 0 && (n2 = function() {
          ...
          if (n3 === void 0 && (n3 = function() {
          }), t3.ads.disableNextSnapshotRestore === true)
        ...
        return a2.init = function(e2, t3, n3) {
          ...
          typeof e2.ads.settings.prerollTimeout == "number" && (a3 = e2.ads.settings.prerollTimeout), this._timeout = e2.setTimeout(function() {
      ...
      var E = function(t2) {
        ...
        return a2.init = function(e2) {
          if (this.waitingForAdBreak = true, e2.ads._contentEnding = true, e2.ads.nopostroll_) {
            ...
            typeof e2.ads.settings.postrollTimeout == "number" && (n3 = e2.ads.settings.postrollTimeout), this._postrollTimeout = e2.setTimeout(function() {
              e2.trigger("adtimeout");
            }, n3);
          }
        }, a2.startLinearAdMode = function() {
      ...
      var F = A.isMiddlewareMediatorSupported, U = e.getTech("Html5").Events, V = { timeout: 5e3, prerollTimeout: void 0, postrollTimeout: void 0, debug: false, stitchedAds: false, contentIsLive: void 0, liveCuePoints: true, allowVjsAutoplay: e.options.normalizeAutoplay || false }, q = function(o2) {
        ...
        U.concat(["firstplay", "loadedalldata"]).forEach(function(e2) {
          ...
          return { disableNextSnapshotRestore: false, _contentEnding: false, _contentHasEnded: false, _hasThereBeenALoadStartDuringPlayerLife: false, _hasThereBeenALoadedData: false, _hasThereBeenALoadedMetaData: false, _inLinearAdMode: false, _shouldBlockPlay: false, _playBlocked: false, _playRequested: false, adType: null, VERSION: a, reset: function() {
            ...
            return t3 !== void 0 && (e.log.warn("Using player.ads.stitchedAds() as a setter is deprecated, it should be set as an option upon initialization of contrib-ads."), this.settings.stitchedAds = !!t3), this.settings.stitchedAds;
            ...
            return n2 === void 0 && (n2 = t2), typeof n2.ads.settings.contentIsLive == "boolean" ? n2.ads.settings.contentIsLive : n2.duration() === 1 / 0 || e.browser.IOS_VERSION === "8" && n2.duration() === 0;
          }, shouldPlayContentBehindAd: function(n2) {
            if (n2 === void 0 && (n2 = t2), n2)
            ...
            return e2 === void 0 && (e2 = t2), !this.shouldPlayContentBehindAd(e2) && !this.stitchedAds();
          }, isInAdMode: function() {
            ...
            if (this.settings.debug) {
              for (var t3 = arguments.length, n2 = new Array(t3), a2 = 0; a2 < t3; a2++)
                n2[a2] = arguments[a2];
              n2.length === 1 && typeof n2[0] == "string" ? e.log("ADS: " + n2[0]) : e.log.apply(e, ["ADS:"].concat(n2));
            }
          } };
          ...
          for (var u2 in a2 = a2.replace(/{pageVariable\.([^}]+)}/g, function(n2, a3) {
            ...
            var u3 = typeof r4;
            return r4 === null ? "null" : r4 === void 0 ? s3["{pageVariable." + a3 + "}"] ? s3["{pageVariable." + a3 + "}"] : (e.log.warn('Page variable "' + a3 + '" not found'), "") : u3 !== "string" && u3 !== "number" && u3 !== "boolean" ? (e.log.warn('Page variable "' + a3 + '" is not a supported type'), "") : h(String(r4), o3);
          }), s3)
        ...
        var d2 = function() {
          ...
          if (!r2.ads.shouldPlayContentBehindAd(r2) && r2.ads.inAdBreak() && r2.tech_.featuresNativeTextTracks && e.browser.IS_IOS && !Array.isArray(r2.textTracks()))
            for (var n2 = 0; n2 < t2.length; n2++) {
              var a2 = t2[n2];
              a2.mode === "showing" && (a2.mode = "disabled");
            }
        };
        r2.ready(function() {
        ...
        !function(e3) {
            ...
            if (e4)
              for (var i3 in e4) {
                ...
                if (r2.nodeName && r2.nodeValue && t4.hasOwnProperty(r2.nodeName)) {
                  var n2 = r2.nodeValue;
                  typeof t4[r2.nodeName] == "boolean" && (n2 = N(n2)), t4[r2.nodeName] = n2;
                }
              }
            ...
            l2 && (r2.adParameters = C.parseNodeText(l2)), C.childrenByName(e4, "TrackingEvents").forEach(function(e5) {
              ...
              C.childrenByName(e5, "MediaFile").forEach(function(e6) {
                r2.mediaFiles.push(function(e7) {
                  ...
                  i5 && typeof i5 == "string" && (t6.scalable = C.parseBoolean(i5));
                  var r3 = e7.getAttribute("maintainAspectRatio");
                  return r3 && typeof r3 == "string" && (t6.maintainAspectRatio = C.parseBoolean(r3)), t6;
                }(e6));
              });
          ...
          var j = { verifyRequiredValues: function e4(t4, i3, r2) {
            if (t4 && t4.nodeName)
              if (t4.nodeName === "InLine" && (r2 = true), M(t4, i3), _(t4)) {
                ...
                C.parseNodeText(t4).length === 0 && F({ name: t4.nodeName, parentName: t4.parentNode.nodeName }, i3);
          ...
          function W(e4, t4) {
            ...
            for (var o2 in a2) {
              ...
              if (["Wrapper", "InLine"].indexOf(s2.nodeName) !== -1 && (s2.nodeName !== "Wrapper" || n2 !== false)) {
                if (C.copyNodeAttribute("id", e4, s2), C.copyNodeAttribute("sequence", e4, s2), C.copyNodeAttribute("adType", e4, s2), s2.nodeName === "Wrapper")
          ...
          var ee = { get: function(e4, t4, i3) {
            ...
            return o(i3, [{ key: "addURLTemplateFilter", value: function(e5) {
              ...
              return v2.length === 1 && s2 != null && (v2[0].sequence = s2), a2 === false && (this.remainingAds = C.splitVAST(v2), v2 = this.remainingAds.shift()), this.resolveAds(v2, { wrapperDepth: d2, previousUrl: c2, url: r2 });
...
var getRollsStatus = (pluginSettings2) => {
  const rolls = {
    pre: pluginSettings2.preroll.adUnit && pluginSettings2.preroll.enabled,
    mid: pluginSettings2.midroll.adUnit && pluginSettings2.midroll.enabled,
    post: pluginSettings2.postroll.adUnit && pluginSettings2.postroll.enabled
  };
  return {
    preroll: rolls.pre,
    midroll: rolls.mid,
...
var createVastSettings = (pluginSettings2, Armanet2, channelName, userData2, videoTags) => {
  const vastSettings = {
    ...
    messages: {
      skip: pluginSettings2.messageSkip,
      skipCountdown: pluginSettings2.messageSkipCountdown
    },
    schedule: []
  };
  if (pluginSettings2.messageRemainingTime.includes("{seconds}")) {
  ...
  const viewer = [userData2 == null ? void 0 : userData2.username, userData2 == null ? void 0 : userData2.email];
  if (rollsStatus2.preroll) {
    vastSettings.schedule.push({
      offset: "pre",
      url: getArmanetVastUrl(pluginSettings2.preroll.adUnit, "pre", channelName, isSkippable, viewer, videoTags)
    });
  }
  if (rollsStatus2.midroll) {
    vastSettings.schedule.push({
      offset: pluginSettings2.midroll.offset,
      url: getArmanetVastUrl(pluginSettings2.midroll.adUnit, "mid", channelName, isSkippable, viewer, videoTags)
    });
  }
  if (rollsStatus2.postroll) {
    vastSettings.schedule.push({
      offset: "post",
      url: getArmanetVastUrl(pluginSettings2.postroll.adUnit, "post", channelName, isSkippable, viewer, videoTags)
    });
  }
  return vastSettings;
};
