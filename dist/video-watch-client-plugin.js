...
var createVastSettings = (pluginSettings, Armanet2, channelName, channelAdUnit, userData, videoTags, video) => {
  const {
    skipTime,
    controlsEnabled,
    messageSkip,
  ...
  registerHook({
    ...
    handler: async ({ path }) => {
      ...
      if (!path.startsWith("/w/"))
        return;
      if (typeof ((_b2 = (_a2 = window.player) == null ? void 0 : _a2.ads) == null ? void 0 : _b2.inAdBreak) === "function") {
        if (window.player.ads.inAdBreak()) {
          window.player.ads.endLinearAdMode();
          cleanupVastElements();
        }
      } else if (((_d = (_c = window.player) == null ? void 0 : _c.ads) == null ? void 0 : _d._inLinearAdMode) !== void 0) {
