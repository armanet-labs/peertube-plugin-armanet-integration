const pluginSettings = [
  ...
  {
    name: 'armanet-excluded-channels',
    label: 'Excluded channels from ads',
    type: 'html',
    descriptionHTML: 'Select the channels that you want to exclude from ads',
    html: `
    <div id="armanet-multi-select" class="armanet-multi-select form-control">
      <div class="select-header">Select Channels</div>
  ...
  {
    name: 'armanet-excluded-channels-data',
    type: 'input',
    private: false,
  },
  {
  ...
  },
  {
    ...
    html: `
      ...
      <div class="armanet-channels-list-pagination"></div>
    `,
  },
];
