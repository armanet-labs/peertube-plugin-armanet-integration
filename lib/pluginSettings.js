const pluginSettings = [
  ...
  },
  {
    ...
    type: 'input',
    descriptionHTML:  'The Ad Unit is the unique identifier for the ad slot. Reach out to your account manager for more information"',
    private: false,
  },
  ...
  },
  {
    ...
    type: 'input',
    descriptionHTML: 'Insert your API KEY from Armanet. Reach out to your account manager for more information"',
    private: true,
  },
  {
  ...
  },
  {
    ...
    label: 'Skip message',
    type: 'input',
    descriptionHTML: 'Message displayed on the clickable button to skip the ad',
    private: false,
    default: 'Skip',
  },
  {
