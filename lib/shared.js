...
export const createVastSettings = (pluginSettings, Armanet, channelName, channelAdUnit, userData, videoTags) => {
  ...
  const getArmanetVastUrl = (adUnit, roll) => {
    const armanetParams = {
      ...
      ...(userData?.username && userData?.email && { viewer: [userData.username, userData.email] }),
