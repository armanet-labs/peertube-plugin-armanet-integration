...
export const createVastSettings = (pluginSettings, Armanet, channelName, userData, videoTags) => {
  const vastSettings = {
  ...
  const getArmanetVastUrl = (adUnit, roll, channel, skippable, viewer, videoTags) => {
